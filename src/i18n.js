...
export const STR = {
  ...
  fa: {
    ...
    menu_body:
      "من ربات <b>نوا</b> هستم. می‌توانم در حدود یک دقیقه پنل پراکسی نوای شخصی‌ات را روی حساب Cloudflare خودت بسازم، به سؤال‌های رایج پاسخ بدهم و تو را به تیم ما وصل کنم.\n\nیکی از گزینه‌های زیر را انتخاب کن.",
